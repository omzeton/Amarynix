...
function AmharicPhoneticKeyPress(pressEvent, amharic) {
  ...
  if (
    keyCode > 4000 ||
    (keyCode > 34 && keyCode <= 57 && keyCode != 44) ||
    (keyCode >= 91 && keyCode <= 93) ||
    (keyCode >= 60 && keyCode <= 64) ||
  ...
  if (
    ...
    var consonantRetVal = convertEnglishConsonantToAmharic(
      lastCharPlain,
      amharicValue,
      shiftKey
    );
    ...
    if (consonantRetVal != null && consonantRetVal.length > 0) {
      ...
      if (amharicValue == "h" && shiftKey == false) {
        ...
        amharic.value =
          amharic.value.substring(0, tempStartPos - 1) +
        ...
        amharic.value =
          amharic.value.substring(0, startPos) +
          consonantRetVal +
    ...
    if (offset != 0) {
      ...
      if (amharic.value.length < 1) {
        ...
        amharic.value.charCodeAt(startPos - 1) == 32 ||
        lastCharPlain == 4959
      ) {
        // if tebeq
        amharic.value = amharic.value + vowelCharacterChar;
        ...
        lastCharEtymology == 4883 ||
        lastCharEtymology == 4683 ||
        lastCharEtymology == 4803 ||
        lastCharEtymology == 4787 ||
        lastCharEtymology == 4747
      ) {
        if (amharicValue == "e" && shiftKey == false)
